...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-969-erd-s-problem-969-b52313e0-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-969"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-969-erd-s-problem-969-b52313e0-v1",
      "problem_contract_sha256": "cedb059c6668a6a4bf31c4b9bf3eea8facd0eb5ccd4bb9984ff05759c9dbe999",
      "problem_id": "problem:um-ep-969-erd-s-problem-969-b52313e0",
      "route_id": "route:um-ep-969-erd-s-problem-969-b52313e0-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-969-erd-s-problem-969-b52313e0-source-fidelity-01",
      "graph_id": "graph:um-ep-969-erd-s-problem-969-b52313e0-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-969-erd-s-problem-969-b52313e0-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-969-erd-s-problem-969-b52313e0-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $Q(x)$ count the number of squarefree integers in $[1,x]$. Determine the order of magnitude in the error term in the asymptotic $ Q(x)=\\frac{6}{\\pi^2}x+E(x). $"
          },
          "statement_sha256": "e68dc00289284811c94d26f7abcaf00ddc7c34d63d91a2bc2f5ad620c63ae496"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-969-erd-s-problem-969-b52313e0-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-969-erd-s-problem-969-b52313e0-root",
      "route_id": "route:um-ep-969-erd-s-problem-969-b52313e0-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-969-54a1c13ddeeb",
        "url": "https://www.unsolvedmath.com/problems/EP-969"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
